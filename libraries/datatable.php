<?php if(!defined('BASEPATH')) exit('No direct script access allowed');
  ...
  * CI Datatable
  *
  * This is a wrapper class/library for Allan Jardine's datatable Jquery plugin that
  * implements the javascript array data source method (http://datatable.net/examples/data_sources/js_array.html)
  *
  ...
  class Datatable
  {
      ...
      */
      ...
      public function __construct(){
          ...
          //$this->ci->config->load('datatable', TRUE);
         
          $this->config = config_item('options', 'datatable');
		  
          //loop over default options, creating default datatable option object
          foreach($this->config as $type=>$option){
              
              //determine whether option is a main datatable option, or a plugin option
              if ($option['_']){
      ...
      */
      ...
      /**
      * Sets a single datatable global option
      *
      ...
      */
      ...
      public function set_option($option, $value, $type = 'main'){
          ...
          if ($type != 'main'){
              ...
              //resolve type if non-datatable name was used
              if (isset($this->config[$type])){
                  
                  //try and resolve option name, since a non-datatable type was used
                  ...
                  //this handles the case where a datatable type name is used 
                  //with a non-datatable option name
              ...
              //try and resolve option name in case non-datatable name was used
      ...
      *
      * @param array $options : array of options, where the key is the datatable/libraries option name
